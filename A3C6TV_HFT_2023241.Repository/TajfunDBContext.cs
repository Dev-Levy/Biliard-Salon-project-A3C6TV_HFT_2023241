...
namespace A3C6TV_HFT_2023241.Repository
{
    public class TajfunDBContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                new Booking(1, "2023-11-14 15:00", "2023-11-14 18:30", 14, 11),
                new Booking(2, "2023-11-14 08:00", "2023-11-14 18:30", 8, 16),
                new Booking(3, "2023-11-14 11:30", "2023-11-14 16:00", 17, 3),
                new Booking(4, "2023-11-14 16:30", "2023-11-14 20:30", 4, 20),
